...
{
	if (range[0][0] >= range[1][0] && range[0][0] <= range[1][1])
		return (1);
	if (range[0][1] >= range[1][0] && range[0][1] <= range[1][1])
		return (1);
	if (range[1][0] >= range[0][0] && range[1][0] <= range[0][1])
		return (1);
	if (range[1][1] >= range[0][0] && range[1][1] <= range[0][1])
		return (1);
	return (0);
}
